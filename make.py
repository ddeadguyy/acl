...
current_test_data = 'test_data_v4' # ACL_PACKING_PRECISION_BOOST ACL_BIND_POSE test_data_v5
...
def do_prepare_regression_test_data(test_data_dir, args):
	...
	for (dirpath, dirnames, filenames) in os.walk(current_test_data_dir):
		for filename in filenames:
			if not filename.endswith('.acl.sjson'): # ACL_PACKING_PRECISION_BOOST ACL_BIND_POSE .acl
				continue
